...
vim.cmd([[
  ...
  let g:python3_host_prog = '/Users/james/.pyenv/versions/py3nvim/bin/python'
]])
...
require('pckr').add{
	...
	{'vim-airline/vim-airline', branch = 'master', requires={"airblade/vim-gitgutter", "mhinz/vim-signify", "lewis6991/gitsigns.nvim"},
		config = function()
			vim.cmd([[
  	...
  	{'vim-airline/vim-airline-themes', branch = 'master', requires={"vim-airline/vim-airline"},
		config=function()
			vim.cmd([[
